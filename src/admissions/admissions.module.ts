...
@Module({
  ...
  providers: [AdmissionsService, StagesService, FeesService, InvoicesService, PpdbService, LettersService],
  exports: [AdmissionsService, StagesService, FeesService, InvoicesService, PpdbService, LettersService],
})
