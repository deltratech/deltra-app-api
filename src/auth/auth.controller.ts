...
export class AuthController {
  ...
  @ApiOperation({ summary: 'Request OTP for password reset (sent via email)' })
  ...
  me(@CurrentUser() user: { userId: string; tenantSlug?: string; isPlatformUser: boolean }) {
    return this.authService.me(user.userId, user.tenantSlug, user.isPlatformUser);
  }
}
